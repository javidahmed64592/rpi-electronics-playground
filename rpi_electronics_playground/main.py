...
def run() -> None:
    ...
    # Initialize ultrasonic sensor with improved accuracy settings
    sensor = UltrasonicSensor(trig_pin=5, echo_pin=6, sample_count=3, filter_size=5, outlier_threshold=3.0)
